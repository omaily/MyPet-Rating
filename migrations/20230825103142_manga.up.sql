...
('Реинкарнация безработного', 'Mushoku Tensei', 'Рифудзин-на Магонотэ', 8.25,       '2014-05-02'),
...
-- CREATE TABLE IF NOT EXISTS author( id bigserial PRIMARY KEY, name TEXT not null)
-- ALTER TABLE manga ADD FOREIGN KEY (author_id) REFERENCES author("id");
-- author_id INTEGER author(id) ON  DELETE CASCADE,

-- start_d TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
