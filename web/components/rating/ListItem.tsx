...
export const ListItem = ({manga}: {manga: Title}): React.ReactElement => {
...
const articleName = (id: number, title: string, title_en: string, rating:number): React.ReactElement => (
...
const headline = (id: number, title: string, title_en: string, rating:number): React.ReactElement => (
    <>
